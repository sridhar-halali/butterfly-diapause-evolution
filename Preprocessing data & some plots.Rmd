...
Some taxa in the data can diapause in both larval and pupal stage. We're recoding these taxa as 'larval' diapause (see Methods in the main for details). Also, for one of the taxa (tip label = UK78_Iliana_sp_) the family is wrongly defined so this will mistake will be corrected in this chunk.

```{r}
head(dat_pruned_skip)
