...
hmm_five_flat <- readRDS("fitHRM_Rstudio_server_RDS files_4Dec2023_1/corhmm_5State_RealUmbral_hrm_fitz.RDS")
hmm_five_fitz <- readRDS("fitHRM_Rstudio_server_RDS files_4Dec2023_1/corhmm_5State_RealUmbral_hrm_flat.RDS")
...
colnames(hmm_five_flat_states) <- c("Adult", "Egg", "Flex", "Larva", "Pupa",
                            "Adult*", "Egg*", "Flex*", "Larva*", "Pupa*")

# Five states-fitz prior
hmm_five_fitz_states <- hmm_five_fitz$states 
colnames(hmm_five_fitz_states) <- c("Adult", "Egg", "Flex", "Larva", "Pupa",
                            "Adult*", "Egg*", "Flex*", "Larva*", "Pupa*")
...
hmm_three_flat <- readRDS("fitHRM_Rstudio_server_RDS files_4Dec2023_1/corhmm_3State_RealUmbral_hrm_fitz.RDS")
hmm_three_fitz <- readRDS("fitHRM_Rstudio_server_RDS files_4Dec2023_1/corhmm_3State_RealUmbral_hrm_flat.RDS")
...
colnames(hmm_three_flat_states) <- c("Adult", "Flex", "Juvenile",
                                    "Adult*", "Flex*", "Juvenile*")
                                    
# Five states-fitz prior
hmm_three_fitz_states <- hmm_three_fitz$states 
colnames(hmm_three_fitz_states) <- c("Adult", "Flex", "Juvenile",
                                    "Adult*", "Flex*", "Juvenile*")
...
# importing hidden rate fitted RDS file
hmm_binary_flat <- readRDS("fitHRM_Rstudio_server_RDS files_4Dec2023_1/corhmm_2State_RealUmbral_hrm_fitz.RDS")
hmm_binary_fitz <- readRDS("fitHRM_Rstudio_server_RDS files_4Dec2023_1/corhmm_2State_RealUmbral_hrm_flat.RDS")

# Extracting states and prepping the dataframe

# Binary states- flat prior
hmm_binary_flat_states <- hmm_binary_flat$states 
colnames(hmm_binary_flat_states) <- c("Diapause", "Flex", "Diapause*", "Flex*")

# Binary states-fitz prior
hmm_binary_fitz_states <- hmm_binary_fitz$states 
colnames(hmm_binary_fitz_states) <- c("Diapause", "Flex", "Diapause*", "Flex*")
