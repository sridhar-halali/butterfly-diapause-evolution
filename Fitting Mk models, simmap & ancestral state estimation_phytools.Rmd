...
##* Table S3: Assessing model fits using log likelihoods & AIC
```{r}
# For flat prior
...
# Combining both data frames (Table S3)
model_fit_fitMK <- rbind(model_fit_flat, model_fit_fitz)
model_fit_fitMK

#write.xlsx(model_fit_fitMK, file= "phytools_fitMK_AIC & logLik_30Apr2024.xlsx")
...
transition_rates <- transition_rates %>% 
  ...
  filter(!transitions %in%  c("Adult-Adult", "Egg-Egg", "no_diapause-no_diapause", "Larva-Larva",
...
transition_rates %>% 
  ...
  geom_jitter(shape=21, size=4, alpha= 0.8, height=0.07) +
...
transition_rates %>% 
  ...
  ggplot(aes(transition_rates, reorder(transitions,transition_rates), fill=model)) +
  geom_jitter(shape=21, size=5, alpha= 0.8, height=0.07) +
  scale_fill_viridis(discrete = TRUE) +
...
transition_rates %>% 
  ...
  ggplot(aes(transition_rates, reorder(transitions,transition_rates), fill=model)) +
  geom_jitter(shape=21, size=5, alpha= 0.8, height=0.05) +
  scale_fill_viridis(discrete = TRUE) +
...
# Fitting fitmultiMk()
using fitmultiMk() we test if transition rates are different across two time regimes: 0-35MY and from 35MY to present. 
see here for e.g. http://blog.phytools.org/2018/11/testing-for-differences-in-rate-or.html
 
```{r}
# Creating time regime (0-35MYA)
ButterflyPhylo_time_map <- make.era.map(ButterflyPhylo, c(0,35))
ButterflyPhylo_time_map

# Five state
ER_DiapauseFive_multimk <- fitmultiMk(ButterflyPhylo_time_map, DiapauseFive, model= "ER")
SYM_DiapauseFive_multimk <- fitmultiMk(ButterflyPhylo_time_map, DiapauseFive, model= "SYM")
ARD_DiapauseFive_multimk <- fitmultiMk(ButterflyPhylo_time_map, DiapauseFive, model= "ARD")

# Three state
ER_DiapauseThree_multimk <- fitmultiMk(ButterflyPhylo_time_map, DiapauseThree, model= "ER")
SYM_DiapauseThree_multimk <- fitmultiMk(ButterflyPhylo_time_map, DiapauseThree, model= "SYM")
ARD_DiapauseThree_multimk <- fitmultiMk(ButterflyPhylo_time_map, DiapauseThree, model= "ARD")

# Binary state
ER_DiapauseBinary_multimk <- fitmultiMk(ButterflyPhylo_time_map, DiapauseBinary, model= "ER")
ARD_DiapauseBinary_multimk <- fitmultiMk(ButterflyPhylo_time_map, DiapauseBinary, model= "ARD")

# save RDS
# saveRDS(ER_DiapauseFive_multimk, file="multiMK_ER_DiapauseFive_fitz.RDS")
# saveRDS(SYM_DiapauseFive_multimk, file="multiMK_SYM_DiapauseFive_fitz.RDS")
# saveRDS(ARD_DiapauseFive_multimk, file="multiMK_ARD_DiapauseFive_fitz.RDS")
# saveRDS(ER_DiapauseThree_multimk, file="multiMK_ER_DiapauseThree_fitz.RDS")
# saveRDS(SYM_DiapauseThree_multimk, file="multiMK_SYM_DiapauseThree_fitz.RDS")
# saveRDS(ARD_DiapauseThree_multimk, file="multiMK_ARD_DiapauseThree_fitz.RDS")
# saveRDS(ER_DiapauseBinary_multimk, file="multiMK_ER_DiapauseBinary_fitz.RDS")
# saveRDS(ARD_DiapauseBinary_multimk, file="multiMK_ARD_DiapauseBinary_fitz.RDS")


# Table S4: Assessing model fits
model_fit_multiMk= data.frame(
  states= rep(c("five", "three", "binary"), times=c(3,3,2)),
  model = c("ER", "SYM", "ARD", "ER", "SYM", "ARD", "ER", "ARD"),
  #root_prior = rep("flat", 8),
  
  logLik= c(ER_DiapauseFive_multimk$logLik, SYM_DiapauseFive_multimk$logLik, ARD_DiapauseFive_multimk$logLik, 
            ER_DiapauseThree_multimk$logLik, SYM_DiapauseThree_multimk$logLik, ARD_DiapauseThree_multimk$logLik,
            ER_DiapauseBinary_multimk$logLik, ARD_DiapauseBinary_multimk$logLik),
  
  AIC= AIC(ER_DiapauseFive_multimk, SYM_DiapauseFive_multimk, ARD_DiapauseFive_multimk, 
           ER_DiapauseThree_multimk, SYM_DiapauseThree_multimk, ARD_DiapauseThree_multimk,
           ER_DiapauseBinary_multimk, ARD_DiapauseBinary_multimk))

model_fit_multiMk

model_fit_multiMk$fitmultiMk_model <- rownames(model_fit_multiMk)
rownames(model_fit_multiMk) <- NULL
...
#DiapauseFive <- factor(DiapauseFive, levels= c("Egg", "Larva", "Pupa", "Adult", "no_diapause"))
# cols_five <- setNames(c("#7EB0DF", "salmon", "#5D9979", "black", "grey"),
#                        c("Egg", "Larva", "Pupa", "Adult", "no_diapause"))

# Three states
DiapauseThree <- factor(DiapauseThree, levels = c("Adult", "Juvenile", "no_diapause"))

cols_three <- setNames(c("black", "salmon", "grey"), 
                       c("Adult", "Juvenile", "no_diapause")) 
...
# Ancestral estimation under the gamma rate model for pi="fitzjohn"
see here for phytools blog on the details and fitting of the model: 
http://blog.phytools.org/2023/12/reconstructing-ancestral-states-of.html
http://blog.phytools.org/2023/12/a-variable-rate-discrete-trait.html

```{r}
# Five state
ER_DiapauseFive_fitz_gamma <- fitgammaMk(ButterflyPhylo, DiapauseFive, model= "ER",
                                           pi= "fitzjohn", rand_start=TRUE, min.alpha=0.01)

SYM_DiapauseFive_fitz_gamma <- fitgammaMk(ButterflyPhylo, DiapauseFive, model= "SYM",  
                                          pi= "fitzjohn", rand_start=TRUE, min.alpha=0.01)

ARD_DiapauseFive_fitz_gamma <- fitgammaMk(ButterflyPhylo, DiapauseFive, model= "ARD",  
                                          pi= "fitzjohn", rand_start=TRUE, min.alpha=0.01)


# Three state
ER_DiapauseThree_fitz_gamma <- fitgammaMk(ButterflyPhylo, DiapauseThree, model= "ER",
                                          pi= "fitzjohn", rand_start=TRUE, min.alpha=0.01)

SYM_DiapauseThree_fitz_gamma <- fitgammaMk(ButterflyPhylo, DiapauseThree, model= "SYM",  
                                           pi= "fitzjohn", rand_start=TRUE, min.alpha=0.01)

ARD_DiapauseThree_fitz_gamma <- fitgammaMk(ButterflyPhylo, DiapauseThree, model= "ARD",  
                                           pi= "fitzjohn", rand_start=TRUE, min.alpha=0.01)


# Binary state
ER_DiapauseBinary_fitz_gamma <- fitgammaMk(ButterflyPhylo, DiapauseBinary, model= "ER",
                                            pi= "fitzjohn", rand_start=TRUE, min.alpha=0.01)

ARD_DiapauseBinary_fitz_gamma <- fitgammaMk(ButterflyPhylo, DiapauseBinary, model= "ARD",  
                                           pi= "fitzjohn", rand_start=TRUE, min.alpha=0.01)



# saving RDS files
# saveRDS(ER_DiapauseFive_fitz_gamma, file="fitgamma_ER_DiapauseFive_fitz.RDS")
# saveRDS(SYM_DiapauseFive_fitz_gamma, file="fitgamma_SYM_DiapauseFive_fitz.RDS")
# saveRDS(ARD_DiapauseFive_fitz_gamma, file="fitgamma_ARD_DiapauseFive_fitz.RDS")
# #saveRDS(ER_DiapauseThree_fitz_gamma, file="fitgamma_ER_DiapauseThree_fitz.RDS")
# saveRDS(SYM_DiapauseThree_fitz_gamma, file="fitgamma_SYM_DiapauseThree_fitz.RDS")
# saveRDS(ARD_DiapauseThree_fitz_gamma, file="fitgamma_ARD_DiapauseThree_fitz.RDS")
# saveRDS(ER_DiapauseBinary_fitz_gamma, file="fitgamma_ER_DiapauseBinary_fitz.RDS")
# saveRDS(ARD_DiapauseBinary_fitz_gamma, file="fitgamma_ARD_DiapauseBinary_fitz.RDS")



# Table S6: Assessing model fits
model_fit_gamma = data.frame(
  states= rep(c("five", "three", "binary"), times=c(3,3,2)),
  model = c("ER", "SYM", "ARD", "ER", "SYM", "ARD", "ER", "ARD"),
  
  logLik= c(ER_DiapauseFive_fitz_gamma$logLik, SYM_DiapauseFive_fitz_gamma$logLik, ARD_DiapauseFive_fitz_gamma$logLik, 
            ER_DiapauseThree_fitz_gamma$logLik, SYM_DiapauseThree_fitz_gamma$logLik, ARD_DiapauseThree_fitz_gamma$logLik,
            ER_DiapauseBinary_fitz_gamma$logLik, ARD_DiapauseBinary_fitz_gamma$logLik),
  
  AIC= AIC(ER_DiapauseFive_fitz_gamma, SYM_DiapauseFive_fitz_gamma, ARD_DiapauseFive_fitz_gamma, 
            ER_DiapauseThree_fitz_gamma, SYM_DiapauseThree_fitz_gamma, ARD_DiapauseThree_fitz_gamma,
            ER_DiapauseBinary_fitz_gamma, ARD_DiapauseBinary_fitz_gamma))

model_fit_gamma

model_fit_flat$fitMk_model <- rownames(model_fit_gamma)
rownames(model_fit_gamma) <- NULL
```


##* Plotting transition rates for the best fitting ARD gamma rate model
```{r}
# Figure S6A: Five states with fitzjohn root
pdf("gamma_fitMk_5States_ARD_FitzJohn.pdf", height=7, width=7)
plot(as.Qmatrix(ARD_DiapauseFive_fitz_gamma), show.zeros=T, color=T, spacer=0.2, cex.rates=0.9, lwd=3,  
     main= "gamma_fitMk_5States_ARD_FitzJohn")
dev.off()

# Figure S6B: Three states with fitzjohn root
pdf("gamma_fitMk_3States_ARD_FitzJohn.pdf", height=7, width=7)
plot(as.Qmatrix(ARD_DiapauseThree_fitz_gamma), show.zeros=T, color=T, spacer=0.2, cex.rates=0.9, lwd=3,  
     main= "gamma_fitMk_3States_FitzJohn")
dev.off()

# Figure S6C: Binary states with fitzjohn root
pdf("gamma_fitMk_Binary_ARD_FitzJohn.pdf", height=7, width=7)
plot(as.Qmatrix(ARD_DiapauseBinary_fitz_gamma), show.zeros=T, color=T, spacer=0.2, cex.rates=0.9, lwd=3,  
     main= "gamma_fitMk_Binary_FitzJohn")
dev.off()

```


##* ML ancestral estimation using gamma rate model
```{r}
# Five states
asrFitzFive_gamma_ML <- ancr(ARD_DiapauseFive_fitz_gamma)

# Three states
asrFitzThree_gamma_ML <- ancr(ARD_DiapauseThree_fitz_gamma)

# Binary states
asrFitzBinary_gamma_ML <- ancr(ARD_DiapauseBinary_fitz_gamma)
...
# Figure S6D: Five states
pdf("gamma_ML_ASR_5State_fitz.pdf", height=7, width=7)

par(fg="transparent")
gamma_pp_five_Fitz_ML <- asrFitzFive_gamma_ML$ace[1:ButterflyPhylo$Nnode,]
...
n<-Ntip(ButterflyPhylo)
h<-max(nodeHeights(ButterflyPhylo))
ii<-order(rowSums(gamma_pp_five_Fitz_ML^2), decreasing=TRUE)
...
for(i in ii){
    plotrix::floating.pie(obj$xx[i+Ntip(ButterflyPhylo)],
        obj$yy[i+Ntip(ButterflyPhylo)],
        radius=if(max(gamma_pp_five_Fitz_ML[i,])<=0.80) 0.03*h else 0.01*h,
        x=gamma_pp_five_Fitz_ML[i,],col=cols_five,border="transparent")
}
...
# Figure S6E: Three states
pdf("gamma_ML_ASR_3State_fitz.pdf", height=7, width=7)

par(fg="transparent")
gamma_pp_three_Fitz_ML <- asrFitzThree_gamma_ML$ace[1:ButterflyPhylo$Nnode,]
...
n<-Ntip(ButterflyPhylo)
h<-max(nodeHeights(ButterflyPhylo))
ii<-order(rowSums(gamma_pp_three_Fitz_ML^2), decreasing=TRUE)
...
for(i in ii){
    plotrix::floating.pie(obj$xx[i+Ntip(ButterflyPhylo)],
        obj$yy[i+Ntip(ButterflyPhylo)],
        radius=if(max(gamma_pp_three_Fitz_ML[i,])<=0.80) 0.03*h else 0.01*h,
        x=gamma_pp_three_Fitz_ML[i,],col=cols_three,border="transparent")
}
...
# Figure S6F: Binary states
pdf("gamma_ML_ASR_Binary_fitz.pdf", height=7, width=7)

par(fg="transparent")
gamma_pp_binary_Fitz_ML <- asrFitzBinary_gamma_ML$ace[1:ButterflyPhylo$Nnode,]
...
n<-Ntip(ButterflyPhylo)
h<-max(nodeHeights(ButterflyPhylo))
ii<-order(rowSums(gamma_pp_binary_Fitz_ML^2), decreasing=TRUE)
...
for(i in ii){
    plotrix::floating.pie(obj$xx[i+Ntip(ButterflyPhylo)],
        obj$yy[i+Ntip(ButterflyPhylo)],
        radius=if(max(gamma_pp_binary_Fitz_ML[i,])<=0.80) 0.03*h else 0.01*h,
        x=gamma_pp_binary_Fitz_ML[i,],col=cols_binary,border="transparent")
}
